...
| 2026-07-16 | GPT-5.6 structured Slow Path, safe demo, raw benchmark artifact support, and Judge-facing docs | Current release-candidate commit | `npm run demo`, provider tests, and benchmark output |
...
1. Replace “Current release-candidate commit” with the immutable release commit
   and tag after the final verification pass.
