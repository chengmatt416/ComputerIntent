...
For a host-independent Python 3.12 AgentLab/Chromium runner and the fail-closed
LHIC semantic-BID adapter, see [the AgentLab runner](agentlab/README.md). The
runner can execute a complete named AgentLab suite and produces a file-hashed
study manifest, but it does not provide gated WorkArena access, a configured
benchmark instance, a public result, or evidence of competitive performance.
